...
*  Genome wide association analysis (GWAS) focus on pregnancy-related outcomes (birthweight and gestational duration) and selected childhood diseases  
*  Polygenic risk score estimation for different traits
*  Logistic regression analysis on polygenic risk score and Neuropsychiatric disorders
*  Mendelian randomization for figuring the relationship between of offspring Birth weight and mental disorder by using polygenic risk score based on offspring/mother GWAS results
*  Integrate Single-cell RNA sequencing data with GWAS results to distinguishes disease association cells
...
* Years of experience on bioinformatics and post-GWAS. 
